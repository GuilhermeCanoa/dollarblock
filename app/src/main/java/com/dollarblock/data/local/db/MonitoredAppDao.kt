...
interface MonitoredAppDao {
    ...
    @Query("UPDATE monitored_apps SET usageBaselineMillis = :baselineMillis WHERE packageName = :packageName")
    suspend fun setUsageBaseline(packageName: String, baselineMillis: Long)
}
